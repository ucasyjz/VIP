...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin, PeftAdapterMixin):
    ...
    def get_time_embed(
        ...
        # print(sample.shape, timesteps.shape)
    ...
    def forward(
        ...
        encoder_hidden_states_center: torch.Tensor,
        encoder_hidden_states_surrounding: torch.Tensor,
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples = downsample_block(
                    ...
                    encoder_hidden_states_center=encoder_hidden_states_center,
                    encoder_hidden_states_surrounding=encoder_hidden_states_surrounding,
