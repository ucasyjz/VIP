...
class StableDiffusionInpaintPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        center_prompt_embeds, negative_prompt_embeds = self.encode_prompt(
            center_prompt,
            device,
            num_images_per_prompt,
            self.do_classifier_free_guidance,
        ...
        surrounding_prompt_embeds, negative_prompt_embeds = self.encode_prompt(
            surrounding_prompt,
            device,
            num_images_per_prompt,
            self.do_classifier_free_guidance,
        ...
        if self.do_classifier_free_guidance:
            ...
            center_prompt_embeds = torch.cat([negative_prompt_embeds, center_prompt_embeds])
            surrounding_prompt_embeds = torch.cat([negative_prompt_embeds, surrounding_prompt_embeds])
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.unet(
                    ...
                    encoder_hidden_states_center=center_prompt_embeds,
                    encoder_hidden_states_surrounding=surrounding_prompt_embeds,
